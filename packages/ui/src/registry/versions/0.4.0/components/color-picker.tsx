...
export function ColorPicker({
	...
	const textInputStyles = clsx(
		"h-10 flex-1 rounded-md border bg-surface-1 px-3 py-2",
		...
		>
			...
			>
				<input
					...
					className={twMerge(
						clsx(
							"h-10 w-10 cursor-pointer rounded-md border border-border p-1 transition-colors hover:border-border-hover",
