...
export function Badge({
	...
	const variantStyles: Record<string, string> = {
		...
		primary: "bg-primary text-primary-on shadow-sm",
		"primary-muted":
		...
		success: "bg-success text-success-on shadow-sm",
		"success-muted":
			"bg-success-muted border border-success text-typography-primary",
		warning: "bg-warning text-warning-on shadow-sm",
		"warning-muted":
			"bg-warning-muted border border-warning text-typography-primary",
		error: "bg-error text-error-on shadow-sm",
