	...
	if (variant === "card") {
		return (
			<BaseRadio.Root
				...
				className={twMerge(
					clsx(
						"group relative flex w-full cursor-pointer items-center gap-3 rounded-md border px-3 py-2.5 transition-all duration-200 ease-in-out",
	...
	return (
		...
		>
			<BaseRadio.Root
				...
				className={twMerge(
					clsx(
						"group flex size-5 cursor-pointer items-center justify-center rounded-full border bg-surface-1 transition-all duration-200 ease-in-out",
						"outline-none ring-offset-2 ring-offset-background",
						"focus-visible:ring-2 focus-visible:ring-primary-focus",
						"disabled:cursor-not-allowed disabled:opacity-50",
