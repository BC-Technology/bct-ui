...
export function FileUpload({
	...
	const dropzoneStyles = clsx(
		"flex w-full flex-col items-center justify-center gap-3 rounded-md border-2 border-dashed bg-surface-1 p-8",
		...
		>
			...
			>
				...
				<div className="text-center">
					<p className="text-base text-typography-primary">
					...
					{value.map((file, index) => (
						...
						>
							...
							<button
								...
								disabled={disabled}
								className="shrink-0 rounded-sm p-1 text-typography-muted transition-colors hover:bg-surface-2 hover:text-error disabled:cursor-not-allowed disabled:opacity-50"
							>
								<X className="size-4" />
							</button>
						</div>
