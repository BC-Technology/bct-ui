...
export function Select({
	...
	const optionStyles = clsx(
		"flex cursor-pointer items-center gap-2 rounded-sm px-3 py-2 text-base text-typography-primary outline-none transition-colors",
		"hover:bg-surface-2",
							...
							{options.map((option) => (
								...
								>
									...
									<div className="flex min-w-0 items-center gap-1">
										...
										{option.description && (
											<span className="truncate text-typography-muted text-xs">
												{option.description}
											</span>
										)}
									</div>
