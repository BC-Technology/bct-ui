			...
			<BaseAlertDialog.Portal>
				...
				<BaseAlertDialog.Popup
					className={twMerge(
						clsx(
							...
							"rounded-lg border border-border bg-surface-1 p-6 shadow-shadow-lg",
				...
				>
					<BaseAlertDialog.Title
						className={twMerge(
							"mb-2 font-semibold text-typography-primary text-xl",
							classNames?.title,
						)}
					>
						{title}
					...
					{description && (
						<BaseAlertDialog.Description
							className={twMerge(
								"mb-6 text-base text-typography-secondary",
					...
					>
						<BaseAlertDialog.Close
							...
							className={twMerge(
								clsx(
									"inline-flex h-10 items-center justify-center rounded-md border border-border px-4 font-medium text-base text-typography-primary transition-colors",
						...
						<BaseAlertDialog.Close
							...
							className={twMerge(
								clsx(
									"inline-flex h-10 items-center justify-center rounded-md px-4 font-medium text-base transition-colors",
									"focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-focus",
