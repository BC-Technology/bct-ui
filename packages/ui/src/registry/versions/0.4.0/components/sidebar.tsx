...
export function Sidebar({
	...
	return (
		<div
			className={twMerge(
				clsx(
					"flex h-full w-full flex-col overflow-x-hidden rounded-lg bg-surface-3 shadow-shadow-sm",
				),
				classNames?.root,
				className,
			)}
			...
			{user && (
				...
				>
					<Popover.Root>
						<Popover.Trigger
							className={clsx(
								"flex w-full cursor-pointer items-center gap-3 rounded-md bg-surface-1/50 px-3 py-2.5 text-typography-primary outline-none transition-all duration-200 ease-in-out",
								"hover:bg-surface-1",
