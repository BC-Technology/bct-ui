		...
		>
			<div className="max-w-xs p-4">
				...
				<p className="text-sm text-typography-secondary">
					This is some helpful information displayed in a popover. Click outside
					to close.
				</p>
			</div>
		</Popover>
...
>
  <div className="p-4 w-80">
    ...
    <div className="mt-4 flex gap-2">
      ...
      <Button size="sm" variant="secondary" onClick={() => {}}>Cancel</Button>
    </div>
  </div>
</Popover>`,
		preview: (
			<Popover trigger={<Button variant="secondary">User Settings</Button>}>
